            ...
            <div class="flex justify-between small-screen">
                <div class="w-8/12 bg-gray-100 overflow-x-hidden overflow-y-scroll p-3 shadow" style="max-height: 400px;">
                    @for($i=0; $i < 5;$i++)
                        <div class="w-full flex items-center justify-between p-2 shadow-md mb-2">
                            ...
                            <div class="flex flex-col mr-2" style="width: 50px;">
                ...
                <div class="w-3/12 p-3">
                    ...
                    <div class="flex flex-col items-start mt-5">
                        <a href="" class="bg-red-600 px-4 text-white button-hover text-sm py-2 my-2">Clear Cart</a>
                        <a href="" class="bg-green-600 px-4 text-white button-hover text-sm py-2 my-2">Checkout</a>
                    </div>
                </div>
            </div>
        </div>
